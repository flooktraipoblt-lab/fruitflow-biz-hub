...
import { BarChart3, FilePlus2, ClipboardList, Users, ReceiptText, CreditCard, UserCheck, MessageCircle } from "lucide-react";
...
const tabs = [
  ...
  { to: "/line-users", label: "LINE Users", Icon: MessageCircle },
];
